...
func (c *userService) AdminLogin(ctx context.Context, in *AdminRequest, opts ...client.CallOption) (*AdminResponse, error) {
...
func (h *userServiceHandler) AdminLogin(ctx context.Context, in *AdminRequest, out *AdminResponse) error {
